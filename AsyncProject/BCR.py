# -*- generated by 1.0.11 -*-
import da
PatternExpr_1355 = da.pat.TuplePattern([da.pat.ConstantPattern('add_client_at_replica'), da.pat.FreePattern('public_key'), da.pat.FreePattern('client_id')])
PatternExpr_1363 = da.pat.FreePattern('olympus')
PatternExpr_2493 = da.pat.TuplePattern([da.pat.ConstantPattern('wedged_request'), da.pat.FreePattern('wedge_request_id')])
PatternExpr_2500 = da.pat.FreePattern('olympus')
PatternExpr_2749 = da.pat.TuplePattern([da.pat.ConstantPattern('send_retransmitted_status'), da.pat.FreePattern('cache_key'), da.pat.FreePattern('sender_replica_id')])
PatternExpr_2758 = da.pat.FreePattern('valid_replica')
PatternExpr_2791 = da.pat.TuplePattern([da.pat.ConstantPattern('acknowledge_retransmission')])
PatternExpr_2796 = da.pat.FreePattern('tail_replica')
PatternExpr_2814 = da.pat.TuplePattern([da.pat.ConstantPattern('truncate_history_till_check_point'), da.pat.FreePattern('completed_checkpoint_proof'), da.pat.FreePattern('checkpoint_identifier')])
PatternExpr_2823 = da.pat.FreePattern('prev_replica')
PatternExpr_3118 = da.pat.TuplePattern([da.pat.ConstantPattern('initiate_checkpointing'), da.pat.FreePattern('checkpoint_proof'), da.pat.FreePattern('checkpoint_identifier')])
PatternExpr_3127 = da.pat.FreePattern('prev_replica')
PatternExpr_3477 = da.pat.TuplePattern([da.pat.ConstantPattern('terminate_replica')])
PatternExpr_3482 = da.pat.FreePattern('olympus')
PatternExpr_3501 = da.pat.TuplePattern([da.pat.ConstantPattern('print_order_proofs')])
PatternExpr_3506 = da.pat.FreePattern('client')
PatternExpr_3537 = da.pat.TuplePattern([da.pat.ConstantPattern('perform_operation'), da.pat.FreePattern('client_request'), da.pat.FreePattern('result'), da.pat.FreePattern('result_shuttle'), da.pat.FreePattern('next_slot_number')])
PatternExpr_3550 = da.pat.FreePattern('valid_process')
PatternExpr_5296 = da.pat.TuplePattern([da.pat.ConstantPattern('retransmitted_request_from_replica_to_head')])
PatternExpr_5474 = da.pat.TuplePattern([da.pat.ConstantPattern('get_running_state'), da.pat.FreePattern('running_state_id')])
PatternExpr_5481 = da.pat.FreePattern('olympus')
PatternExpr_5606 = da.pat.TuplePattern([da.pat.ConstantPattern('new_configuration'), da.pat.FreePattern('running_state')])
PatternExpr_5613 = da.pat.FreePattern('olympus')
PatternExpr_5658 = da.pat.TuplePattern([da.pat.ConstantPattern('perform_catchup_to_maximal_order_proof'), da.pat.FreePattern('catchup_message'), da.pat.FreePattern('catchup_msg_identifier')])
PatternExpr_5667 = da.pat.FreePattern('olympus')
PatternExpr_5966 = da.pat.TuplePattern([da.pat.ConstantPattern('initiating_retransmit_request'), da.pat.FreePattern('client_request')])
PatternExpr_5973 = da.pat.FreePattern('valid_process')
PatternExpr_6404 = da.pat.TuplePattern([da.pat.ConstantPattern('cache_result_shuttle'), da.pat.FreePattern('client_id'), da.pat.FreePattern('request_id'), da.pat.FreePattern('retransmit_id'), da.pat.FreePattern('result_shuttle'), da.pat.FreePattern('result')])
PatternExpr_6725 = da.pat.TuplePattern([da.pat.ConstantPattern('store_keys'), da.pat.FreePattern('public_key'), da.pat.FreePattern('private_key'), da.pat.FreePattern('public_keys')])
PatternExpr_6771 = da.pat.TuplePattern([da.pat.ConstantPattern('KeysFound')])
PatternExpr_6776 = da.pat.SelfPattern()
PatternExpr_6794 = da.pat.TuplePattern([da.pat.ConstantPattern('done')])
PatternExpr_6799 = da.pat.SelfPattern()
PatternExpr_6779 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.SelfPattern()]), da.pat.TuplePattern([da.pat.ConstantPattern('KeysFound')])])
PatternExpr_6802 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.SelfPattern()]), da.pat.TuplePattern([da.pat.ConstantPattern('done')])])
PatternExpr_8917 = da.pat.TuplePattern([da.pat.ConstantPattern('register_client_at_olympus'), da.pat.FreePattern('public_key'), da.pat.FreePattern('client_id')])
PatternExpr_8926 = da.pat.FreePattern('client')
PatternExpr_9001 = da.pat.TuplePattern([da.pat.ConstantPattern('client_registered_at_replica'), da.pat.FreePattern('client_id'), da.pat.FreePattern('replica_id')])
PatternExpr_9010 = da.pat.FreePattern('client')
PatternExpr_10500 = da.pat.TuplePattern([da.pat.ConstantPattern('reconfigure_request'), da.pat.FreePattern('replica_id')])
PatternExpr_10507 = da.pat.FreePattern('process_cli_replica')
PatternExpr_10861 = da.pat.TuplePattern([da.pat.ConstantPattern('running_state_from_replica'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('running_state')])
PatternExpr_10870 = da.pat.FreePattern('client')
PatternExpr_10885 = da.pat.TuplePattern([da.pat.ConstantPattern('caughtup_message'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('caughtup_message')])
PatternExpr_10894 = da.pat.FreePattern('client')
PatternExpr_10915 = da.pat.TuplePattern([da.pat.ConstantPattern('wedged_statement_from_replica'), da.pat.FreePattern('wedged_statement'), da.pat.FreePattern('replica_id')])
PatternExpr_10924 = da.pat.FreePattern('client')
PatternExpr_10953 = da.pat.TuplePattern([da.pat.ConstantPattern('get_current_active_configuration_from_olympus'), da.pat.FreePattern('client_id')])
PatternExpr_10960 = da.pat.FreePattern('client')
PatternExpr_10998 = da.pat.TuplePattern([da.pat.ConstantPattern('done')])
PatternExpr_11003 = da.pat.SelfPattern()
PatternExpr_11006 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.SelfPattern()]), da.pat.TuplePattern([da.pat.ConstantPattern('done')])])
PatternExpr_11482 = da.pat.TuplePattern([da.pat.ConstantPattern('received_active_configuration_at_client'), da.pat.FreePattern('replica_set'), da.pat.FreePattern('public_keys')])
PatternExpr_11490 = da.pat.FreePattern('olympus')
PatternExpr_11575 = da.pat.TuplePattern([da.pat.ConstantPattern('client_registered_at_olympus'), da.pat.FreePattern('parent_process')])
PatternExpr_11581 = da.pat.FreePattern('olympus')
PatternExpr_11605 = da.pat.TuplePattern([da.pat.ConstantPattern('last_served_request'), da.pat.FreePattern('result_shuttle')])
PatternExpr_11612 = da.pat.FreePattern('olympus')
PatternExpr_11724 = da.pat.TuplePattern([da.pat.ConstantPattern('parent_sent_result'), da.pat.FreePattern('result_parent')])
PatternExpr_11731 = da.pat.FreePattern('parent_process')
PatternExpr_11954 = da.pat.TuplePattern([da.pat.ConstantPattern('result_shuttle'), da.pat.FreePattern('result_shuttle'), da.pat.FreePattern('result'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('response_request_id')])
PatternExpr_11967 = da.pat.FreePattern('tail_replica')
PatternExpr_12089 = da.pat.TuplePattern([da.pat.ConstantPattern('parent_performed_operation'), da.pat.FreePattern('globalseqid')])
PatternExpr_12096 = da.pat.FreePattern('parent_process')
PatternExpr_12152 = da.pat.TuplePattern([da.pat.ConstantPattern('client_registered_at_olympus'), da.pat.FreePattern(None)])
PatternExpr_12158 = da.pat.FreePattern('olympus')
PatternExpr_12533 = da.pat.TuplePattern([da.pat.ConstantPattern('done')])
PatternExpr_12538 = da.pat.SelfPattern()
PatternExpr_13435 = da.pat.TuplePattern([da.pat.ConstantPattern('get_result_from_parent_process'), da.pat.FreePattern('globalseqid')])
PatternExpr_13442 = da.pat.FreePattern('client')
PatternExpr_13498 = da.pat.TuplePattern([da.pat.ConstantPattern('parent_perform_operation'), da.pat.FreePattern('client_id'), da.pat.FreePattern('request_id'), da.pat.FreePattern('operation')])
PatternExpr_13509 = da.pat.FreePattern('client')
PatternExpr_13774 = da.pat.ConstantPattern('done')
PatternExpr_13778 = da.pat.SelfPattern()
PatternExpr_13781 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.SelfPattern()]), da.pat.ConstantPattern('done')])
_config_object = {}
import sys
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_1355, sources=[PatternExpr_1363], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_1354]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_2493, sources=[PatternExpr_2500], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2492]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_2749, sources=[PatternExpr_2758], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2748]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_2791, sources=[PatternExpr_2796], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2790]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_2814, sources=[PatternExpr_2823], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2813]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_3118, sources=[PatternExpr_3127], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3117]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_3477, sources=[PatternExpr_3482], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3476]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_3501, sources=[PatternExpr_3506], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3500]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_3537, sources=[PatternExpr_3550], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3536]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_5296, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_5295]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_10', PatternExpr_5474, sources=[PatternExpr_5481], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_5473]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_11', PatternExpr_5606, sources=[PatternExpr_5613], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_5605]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_12', PatternExpr_5658, sources=[PatternExpr_5667], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_5657]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_13', PatternExpr_5966, sources=[PatternExpr_5973], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_5965]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_14', PatternExpr_6404, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_6403]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_15', PatternExpr_6725, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_6724]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_16', PatternExpr_6771, sources=[PatternExpr_6776], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_17', PatternExpr_6794, sources=[PatternExpr_6799], destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, T, replica_Set, replica_Id, config_file, configuration_id, **rest_13791):
        super().setup(T=T, replica_Set=replica_Set, replica_Id=replica_Id, config_file=config_file, configuration_id=configuration_id, **rest_13791)
        self._state.T = T
        ...
        if (self._state.checkpointing_interval is None):
            self._state.checkpointing_interval = (- 1)
    ...
    def run(self):
        super()._label('_st_label_6768', block=False)
        _st_label_6768 = 0
        while (_st_label_6768 == 0):
            _st_label_6768 += 1
            if PatternExpr_6779.match_iter(self._ReplicaReceivedEvent_16, SELF_ID=self._id):
                _st_label_6768 += 1
            else:
                super()._label('_st_label_6768', block=True)
                _st_label_6768 -= 1
        super()._label('_st_label_6791', block=False)
        _st_label_6791 = 0
        while (_st_label_6791 == 0):
            _st_label_6791 += 1
            if PatternExpr_6802.match_iter(self._ReplicaReceivedEvent_17, SELF_ID=self._id):
                _st_label_6791 += 1
            else:
                super()._label('_st_label_6791', block=True)
                _st_label_6791 -= 1
    ...
    def change_operation_failure(self, client_request, client_id, request_id):
        self.output(((((('changing operation for client_id' + str(client_id)) + ' request_id ') + str(request_id)) + ' replica_id ') + str(self._state.replica_id)))
    ...
    def _Replica_handler_1354(self, public_key, client_id, olympus):
    ...
    _Replica_handler_1354._labels = None
    _Replica_handler_1354._notlabels = None

    def _Replica_handler_2492(self, wedge_request_id, olympus):
    ...
    _Replica_handler_2492._labels = None
    _Replica_handler_2492._notlabels = None

    def _Replica_handler_2748(self, cache_key, sender_replica_id, valid_replica):
    ...
    _Replica_handler_2748._labels = None
    _Replica_handler_2748._notlabels = None

    def _Replica_handler_2790(self, tail_replica):
    ...
    _Replica_handler_2790._labels = None
    _Replica_handler_2790._notlabels = None

    def _Replica_handler_2813(self, completed_checkpoint_proof, checkpoint_identifier, prev_replica):
    ...
    _Replica_handler_2813._labels = None
    _Replica_handler_2813._notlabels = None

    def _Replica_handler_3117(self, checkpoint_proof, checkpoint_identifier, prev_replica):
        if (not (checkpoint_identifier == self._state.checkpoint_id)):
            ...
            self._state.logger.error('initiate_checkpointing:calling reconfig provable case of misbehaviour detected for checkpoint_identifier:%s,replica_id:%s checkpoint_identifier is invalid', str(checkpoint_identifier), str(self._state.replica_id))
            return
        super()._label('_st_label_3155', block=False)
        _st_label_3155 = 0
        while (_st_label_3155 == 0):
            _st_label_3155 += 1
            if ((self._state.current_slot_number % self._state.checkpointing_interval) == 0):
                _st_label_3155 += 1
            else:
                super()._label('_st_label_3155', block=True)
                _st_label_3155 -= 1
        self._state.logger.info(('initiate_checkpointing:performing checkpoining checkpoint_identifier ' + str(checkpoint_identifier)))
        checkpoint_failures = self.get_pending_failures_if_exists(None, checkpoint_identifier, 'checkpoint')
        self._state.logger.info((('initiate_checkpointing:performing checkpoining checkpoint_identifier ' + str(checkpoint_identifier)) + ' after getting pending failures'))
        for checkpoint_failure in checkpoint_failures:
            if (not (checkpoint_failure is None)):
                ...
                if (self._state.pending_sleep_statements > 0):
                    self.sleep_failure()
        self._state.logger.info((('initiate_checkpointing:performing checkpoining checkpoint_identifier ' + str(checkpoint_identifier)) + ' after processing pending failures'))
        ...
        self._state.logger.info((('initiate_checkpointing:performing checkpoining checkpoint_identifier ' + str(checkpoint_identifier)) + ' ready to send to next replica'))
        if (self._state.is_head_replica is False):
            if (self.validate_check_point_proofs(checkpoint_proof, checkpoint_identifier) is False):
                self._state.logger.error('initiate_checkpointing:checkpoint validation failed, need to call reconfig provable case of misbehaviour detected at replica_id:%s ,checkpoint_identifier:%s', str(self._state.replica_id), str(checkpoint_identifier))
    ...
    _Replica_handler_3117._labels = None
    _Replica_handler_3117._notlabels = None

    def _Replica_handler_3476(self, olympus):
        print(('process terminated replica_id' + str(self._state.replica_id)))
        os._exit((- 1))
    _Replica_handler_3476._labels = None
    _Replica_handler_3476._notlabels = None

    def _Replica_handler_3500(self, client):
        replica_history = self._state.history
        order_proofs = replica_history.get_order_proofs()
        self._state.logger.info((('replica_id: ' + str(self._state.replica_id)) + ' order_proofs: '), str(order_proofs))
    _Replica_handler_3500._labels = None
    _Replica_handler_3500._notlabels = None

    def _Replica_handler_3536(self, client_request, result, result_shuttle, next_slot_number, valid_process):
        ...
        if (self.is_registered_client(client_id) is False):
            ...
            if ((cache_key in self._state.result_cache) and (self._state.result_cache[cache_key] is True)):
                ...
                self._state.current_slot_number = (self._state.current_slot_number + 1)
    _Replica_handler_3536._labels = None
    _Replica_handler_3536._notlabels = None

    def _Replica_handler_5295(self):
    ...
    _Replica_handler_5295._labels = None
    _Replica_handler_5295._notlabels = None

    def _Replica_handler_5473(self, running_state_id, olympus):
    ...
    _Replica_handler_5473._labels = None
    _Replica_handler_5473._notlabels = None

    def _Replica_handler_5605(self, running_state, olympus):
    ...
    _Replica_handler_5605._labels = None
    _Replica_handler_5605._notlabels = None

    def _Replica_handler_5657(self, catchup_message, catchup_msg_identifier, olympus):
    ...
    _Replica_handler_5657._labels = None
    _Replica_handler_5657._notlabels = None

    def _Replica_handler_5965(self, client_request, valid_process):
        client_id = client_request.get_client_id()
        request_id = client_request.get_request_id()
        operation = client_request.get_operation()
        client_process = client_request.get_client_process_info()
        ...
        if (self.is_registered_client(client_id) is False):
            ...
            if ((not (cached_object is None)) and (not (cached_object == True))):
                ...
                super()._label('_st_label_6156', block=False)
                _st_label_6156 = 0
                while (_st_label_6156 == 0):
                    _st_label_6156 += 1
                    if (self._state.retransmit_acknowledged == 2):
                        _st_label_6156 += 1
                    else:
                        super()._label('_st_label_6156', block=True)
                        _st_label_6156 -= 1
                if (self.check_in_order_proof(request_id) is False):
                    ...
                    super()._label('_st_label_6197', block=False)
                    _st_label_6197 = 0
                    self._timer_start()
                    while (_st_label_6197 == 0):
                        _st_label_6197 += 1
                        if (self._state.switch == 2):
                            ...
                            super()._label('_st_label_6197', block=True, timeout=self._state.replica_timeout)
                            _st_label_6197 -= 1
                else:
                    ...
                    self._state.switch = 1
                    super()._label('_st_label_6259', block=False)
                    _st_label_6259 = 0
                    self._timer_start()
                    while (_st_label_6259 == 0):
                        _st_label_6259 += 1
                        if (self._state.switch == 2):
                            pass
                            _st_label_6259 += 1
                            ...
                            super()._label('_st_label_6259', block=True, timeout=self._state.replica_timeout)
                            _st_label_6259 -= 1
            else:
                self._state.logger.info(((('send_retransmitted_status: cache_key ' + str(cache_key)) + ' at replica_id ') + str(self._state.replica_id)))
                self.send(('send_retransmitted_status', cache_key, self._state.replica_id), to=self._state.tail_replica)
                self._state.retransmit_acknowledged = 1
                super()._label('_st_label_6326', block=False)
                _st_label_6326 = 0
                while (_st_label_6326 == 0):
                    _st_label_6326 += 1
                    if (self._state.retransmit_acknowledged == 2):
                        _st_label_6326 += 1
                    else:
                        super()._label('_st_label_6326', block=True)
                        _st_label_6326 -= 1
                self._state.logger.info("retransmitting_to_head_replica: 'perform_operation' with client_id=%s, request_id=%s, operation=%s TO head_replica", str(client_id), str(request_id), str(operation))
                self.send(('perform_operation', client_request, None, None, None), to=self._state.head_replica)
                (self._state.switch == 1)
                super()._label('_st_label_6362', block=False)
                _st_label_6362 = 0
                self._timer_start()
                while (_st_label_6362 == 0):
                    _st_label_6362 += 1
                    if (self._state.switch == 2):
                        pass
                        _st_label_6362 += 1
                        ...
                        super()._label('_st_label_6362', block=True, timeout=self._state.replica_timeout)
                        _st_label_6362 -= 1
    _Replica_handler_5965._labels = None
    _Replica_handler_5965._notlabels = None

    def _Replica_handler_6403(self, client_id, request_id, retransmit_id, result_shuttle, result):
        if (self._state.replica_state == self._state.Immutable):
    ...
    _Replica_handler_6403._labels = None
    _Replica_handler_6403._notlabels = None

    def _Replica_handler_6724(self, public_key, private_key, public_keys):
    ...
    _Replica_handler_6724._labels = None
    _Replica_handler_6724._notlabels = None
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_8917, sources=[PatternExpr_8926], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_8916]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_9001, sources=[PatternExpr_9010], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_9000]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_10500, sources=[PatternExpr_10507], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_10499]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_10861, sources=[PatternExpr_10870], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_10860]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_10885, sources=[PatternExpr_10894], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_10884]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_5', PatternExpr_10915, sources=[PatternExpr_10924], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_10914]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_6', PatternExpr_10953, sources=[PatternExpr_10960], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_10952]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_7', PatternExpr_10998, sources=[PatternExpr_11003], destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, T, count, config_file, **rest_13791):
        super().setup(T=T, count=count, config_file=config_file, **rest_13791)
        self._state.T = T
    ...
    def run(self):
        ...
        super()._label('_st_label_10995', block=False)
        _st_label_10995 = 0
        while (_st_label_10995 == 0):
            _st_label_10995 += 1
            if PatternExpr_11006.match_iter(self._OlympusReceivedEvent_7, SELF_ID=self._id):
                _st_label_10995 += 1
            else:
                super()._label('_st_label_10995', block=True)
                _st_label_10995 -= 1
        ...
        while (len(self._state.wedged_statements) > self._state.T):
            ...
            while True:
                ...
                for i in range(0, len(quorums_of_replicas)):
                    ...
                    super()._label('_st_label_10295', block=False)
                    _st_label_10295 = 0
                    while (_st_label_10295 == 0):
                        _st_label_10295 += 1
                        if (self._state.count_of_caughtup_messages == len(valid_quorum_of_replicas)):
                            _st_label_10295 += 1
                        else:
                            super()._label('_st_label_10295', block=True)
                            _st_label_10295 -= 1
                    else:
                        if (_st_label_10295 != 2):
                            continue
                    if (_st_label_10295 != 2):
                        break
                    if (self.validate_runningstate_in_caughtup_messages() is True):
                        ...
                        while (len(quorum_of_replicas) > 0):
                            ...
                            self._state.has_received_running_state_from_random_replica = 0
                            super()._label('_st_label_10361', block=False)
                            _st_label_10361 = 0
                            while (_st_label_10361 == 0):
                                _st_label_10361 += 1
                                if (self._state.has_received_running_state_from_random_replica == 1):
                                    _st_label_10361 += 1
                                else:
                                    super()._label('_st_label_10361', block=True)
                                    _st_label_10361 -= 1
                            else:
                                if (_st_label_10361 != 2):
                                    continue
                            if (_st_label_10361 != 2):
                                break
    ...
    def perform_reconfiguration(self, running_state):
        ...
        for client_id in client_process_info_temp:
            ...
            super()._label('_st_label_10651', block=False)
            _st_label_10651 = 0
            while (_st_label_10651 == 0):
                _st_label_10651 += 1
                if (self._state.count_of_registrations[client_id] == len(self._state.replica_set)):
                    _st_label_10651 += 1
                else:
                    super()._label('_st_label_10651', block=True)
                    _st_label_10651 -= 1
            else:
                if (_st_label_10651 != 2):
                    continue
            if (_st_label_10651 != 2):
                break
    ...
    def _Olympus_handler_8916(self, public_key, client_id, client):
        ...
        self.send(('add_client_at_replica', public_key, client_id), to=self._state.replica_set.values())
        self._state.logger.info("sent: 'add_client_at_replica'-client_id=%s, TO all the replicas", str(client_id))
        super()._label('_st_label_8975', block=False)
        _st_label_8975 = 0
        while (_st_label_8975 == 0):
            _st_label_8975 += 1
            if (self._state.count_of_registrations[client_id] == len(self._state.replica_set)):
                _st_label_8975 += 1
            else:
                super()._label('_st_label_8975', block=True)
                _st_label_8975 -= 1
    ...
    _Olympus_handler_8916._labels = None
    _Olympus_handler_8916._notlabels = None

    def _Olympus_handler_9000(self, client_id, replica_id, client):
    ...
    _Olympus_handler_9000._labels = None
    _Olympus_handler_9000._notlabels = None

    def _Olympus_handler_10499(self, replica_id, process_cli_replica):
        ...
        time.sleep(1)
        super()._label('_st_label_10549', block=False)
        _st_label_10549 = 0
        while (_st_label_10549 == 0):
            _st_label_10549 += 1
            if (self._state.count_of_wedged_statements > self._state.T):
                _st_label_10549 += 1
            else:
                super()._label('_st_label_10549', block=True)
                _st_label_10549 -= 1
        self.find_quorum_of_replicas()
    _Olympus_handler_10499._labels = None
    _Olympus_handler_10499._notlabels = None

    def _Olympus_handler_10860(self, replica_id, running_state, client):
        self._state.current_running_state = running_state
        self._state.has_received_running_state_from_random_replica = 1
    _Olympus_handler_10860._labels = None
    _Olympus_handler_10860._notlabels = None

    def _Olympus_handler_10884(self, replica_id, caughtup_message, client):
    ...
    _Olympus_handler_10884._labels = None
    _Olympus_handler_10884._notlabels = None

    def _Olympus_handler_10914(self, wedged_statement, replica_id, client):
    ...
    _Olympus_handler_10914._labels = None
    _Olympus_handler_10914._notlabels = None

    def _Olympus_handler_10952(self, client_id, client):
    ...
    _Olympus_handler_10952._labels = None
    _Olympus_handler_10952._notlabels = None
...
class Client(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_0', PatternExpr_11482, sources=[PatternExpr_11490], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_11481]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_1', PatternExpr_11575, sources=[PatternExpr_11581], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_11574]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_2', PatternExpr_11605, sources=[PatternExpr_11612], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_11604]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_3', PatternExpr_11724, sources=[PatternExpr_11731], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_11723]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_4', PatternExpr_11954, sources=[PatternExpr_11967], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_11953]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_5', PatternExpr_12089, sources=[PatternExpr_12096], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_12088]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_6', PatternExpr_12152, sources=[PatternExpr_12158], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_7', PatternExpr_12533, sources=[PatternExpr_12538], destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, client_id, olympus, T, config_file, **rest_13791):
        super().setup(client_id=client_id, olympus=olympus, T=T, config_file=config_file, **rest_13791)
    ...
    def run(self):
        ...
        current_time = time.time()
        super()._label('_st_label_12493', block=False)
        _st_label_12493 = 0
        while (_st_label_12493 == 0):
            _st_label_12493 += 1
            if (self._state.received_active_config_at_client == 1):
                _st_label_12493 += 1
            else:
                super()._label('_st_label_12493', block=True)
                _st_label_12493 -= 1
        ...
        super()._label('_st_label_12530', block=False)

        def ExistentialOpExpr_12531():
            for (_, (_, _, _ConstantPattern12547_), (_ConstantPattern12550_,)) in self._ClientReceivedEvent_7:
                if (_ConstantPattern12547_ == self._id):
                    if (_ConstantPattern12550_ == 'done'):
                        if True:
                            return True
            return False
        _st_label_12530 = 0
        while (_st_label_12530 == 0):
            _st_label_12530 += 1
            if ExistentialOpExpr_12531():
                _st_label_12530 += 1
            else:
                super()._label('_st_label_12530', block=True)
                _st_label_12530 -= 1
    ...
    def is_verified_result(self, client_id, request_id):
        ...
        if ((int(client_id) == 1) and (int(request_id) == 110)):
            print(((('returning for key ' + str(cache_key)) + ' value ') + str((cache_key in self._state.verified_result))))
    ...
    def process_result_shuttle(self, result, response_request_id, result_shuttle):
        ...
        super()._label('_st_label_11872', block=False)
        _st_label_11872 = 0
        while (_st_label_11872 == 0):
            _st_label_11872 += 1
            if (self._state.parent_switch == 2):
                _st_label_11872 += 1
            else:
                super()._label('_st_label_11872', block=True)
                _st_label_11872 -= 1
    ...
    def register_client_and_get_active_configuration_from_olympus(self):
        ...
        super()._label('_st_label_12149', block=False)
        olympus = None

        def ExistentialOpExpr_12150():
            nonlocal olympus
            for (_, (_, _, self._state.olympus), (_ConstantPattern12168_, _)) in self._ClientReceivedEvent_6:
                if (_ConstantPattern12168_ == 'client_registered_at_olympus'):
                    if True:
                        return True
            return False
        _st_label_12149 = 0
        while (_st_label_12149 == 0):
            _st_label_12149 += 1
            if ExistentialOpExpr_12150():
                _st_label_12149 += 1
            else:
                super()._label('_st_label_12149', block=True)
                _st_label_12149 -= 1
    ...
    def handle_operation(self):
        ...
        print(((((('operation is ' + str(operation)) + ' at client_id ') + str(self._state.client_id)) + ' request_id is ') + str(self._state.request_id)))
        ...
        super()._label('_st_label_12269', block=False)
        _st_label_12269 = 0
        while (_st_label_12269 == 0):
            _st_label_12269 += 1
            if (self._state.parent_request_switch == 2):
                _st_label_12269 += 1
            else:
                super()._label('_st_label_12269', block=True)
                _st_label_12269 -= 1
        self._state.switch = 1
        ...
        super()._label('_st_label_12327', block=False)
        _st_label_12327 = 0
        self._timer_start()
        while (_st_label_12327 == 0):
            _st_label_12327 += 1
            if (self._state.switch == 2):
                ...
                self._state.retransmit_switch = 1
                super()._label('_st_label_12412', block=False)
                _st_label_12412 = 0
                self._timer_start()
                while (_st_label_12412 == 0):
                    _st_label_12412 += 1
                    if (self._state.retransmit_switch == 2):
                        ...
                        self.output(((('retransmitted_request:error provable case of misbehaviour for client_id ' + str(self._state.client_id)) + ' request_id ') + str(self._state.request_id)))
                        self._state.logger.info('failed failed failed')
                        _st_label_12412 += 1
                    else:
                        super()._label('_st_label_12412', block=True, timeout=self._state.client_timeout)
                        _st_label_12412 -= 1
                _st_label_12327 += 1
            else:
                super()._label('_st_label_12327', block=True, timeout=self._state.client_timeout)
                _st_label_12327 -= 1
    ...
    def _Client_handler_11481(self, replica_set, public_keys, olympus):
    ...
    _Client_handler_11481._labels = None
    _Client_handler_11481._notlabels = None

    def _Client_handler_11574(self, parent_process, olympus):
    ...
    _Client_handler_11574._labels = None
    _Client_handler_11574._notlabels = None

    def _Client_handler_11604(self, result_shuttle, olympus):
        ...
        if ((not (result_shuttle.get_result() is None)) and (result_shuttle.get_request_id() == self._state.request_id)):
            ...
            self.get_active_configuration_from_olympus()
            super()._label('_st_label_11671', block=False)
            _st_label_11671 = 0
            while (_st_label_11671 == 0):
                _st_label_11671 += 1
                if (self._state.received_active_config_at_client == 1):
                    _st_label_11671 += 1
                else:
                    super()._label('_st_label_11671', block=True)
                    _st_label_11671 -= 1
            ...
            self.get_active_configuration_from_olympus()
            super()._label('_st_label_11707', block=False)
            _st_label_11707 = 0
            while (_st_label_11707 == 0):
                _st_label_11707 += 1
                if (self._state.received_active_config_at_client == 1):
                    _st_label_11707 += 1
                else:
                    super()._label('_st_label_11707', block=True)
                    _st_label_11707 -= 1
            self._state.logger.info('last_served_request:done received_active_config_at_client after reconfiguration')
            self.handle_operation()
    _Client_handler_11604._labels = None
    _Client_handler_11604._notlabels = None

    def _Client_handler_11723(self, result_parent, parent_process):
    ...
    _Client_handler_11723._labels = None
    _Client_handler_11723._notlabels = None

    def _Client_handler_11953(self, result_shuttle, result, replica_id, response_request_id, tail_replica):
    ...
    _Client_handler_11953._labels = None
    _Client_handler_11953._notlabels = None

    def _Client_handler_12088(self, globalseqid, parent_process):
    ...
    _Client_handler_12088._labels = None
    _Client_handler_12088._notlabels = None
...
class ParentProcess(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ParentProcessReceivedEvent_0', PatternExpr_13435, sources=[PatternExpr_13442], destinations=None, timestamps=None, record_history=None, handlers=[self._ParentProcess_handler_13434]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ParentProcessReceivedEvent_1', PatternExpr_13498, sources=[PatternExpr_13509], destinations=None, timestamps=None, record_history=None, handlers=[self._ParentProcess_handler_13497]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ParentProcessReceivedEvent_2', PatternExpr_13774, sources=[PatternExpr_13778], destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, total_replica_count, **rest_13791):
        super().setup(total_replica_count=total_replica_count, **rest_13791)
    ...
    def run(self):
        super()._label('_st_label_13771', block=False)
        _st_label_13771 = 0
        while (_st_label_13771 == 0):
            _st_label_13771 += 1
            if PatternExpr_13781.match_iter(self._ParentProcessReceivedEvent_2, SELF_ID=self._id):
                _st_label_13771 += 1
            else:
                super()._label('_st_label_13771', block=True)
                _st_label_13771 -= 1
    ...
    def _ParentProcess_handler_13434(self, globalseqid, client):
    ...
    _ParentProcess_handler_13434._labels = None
    _ParentProcess_handler_13434._notlabels = None

    def _ParentProcess_handler_13497(self, client_id, request_id, operation, client):
        cache_key = ((('00000' + str(client_id)) + '11111') + str(request_id))
    ...
    _ParentProcess_handler_13497._labels = None
    _ParentProcess_handler_13497._notlabels = None
